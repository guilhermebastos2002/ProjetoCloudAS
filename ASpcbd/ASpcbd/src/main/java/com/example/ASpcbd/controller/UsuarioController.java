...
import com.example.ASpcbd.service.UsuarioService;
...
public class UsuarioController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Usuario> updateUsuario(@PathVariable("id") int id, @Valid @RequestBody Usuario novosDados) {
